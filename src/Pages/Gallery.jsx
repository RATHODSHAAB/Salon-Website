    ...
    <>
      ...
      <div
        className="gallery-bg
                min-h-[30vh] md:min-h-[40vh] lg:min-h-[45vh]
                w-full
                bg-center bg-contain md:bg-cover
                text-amber-50
                flex justify-center items-center"
      >
        <div
          className="text-4xl md:text-5xl lg:text-6xl tracking-wider"
      ...
      <div className="mt-24 flex justify-center px-2 mb-10">
        <CompGaller
          title={"THE STUDIO"}
          description1={
            "Explore the Lola Hair Studio gallery and discover artistry that defines our work. From precision cuts and dimensional color to balayage and Bellami extensions,   each style highlights the individuality of our guests. Our gallery also features stunning  transformations and custom styling, from everyday looks to special occasion finishes."
          }
          description2={
            " Our gallery also features stunning transformations and custom styling, from everyday looks to special occasion finishes. Every image reflects the skill and passion of our team, dedicated to creating results that inspire confidence."
          }
          images={std_images}
        />
      </div>
